  ...
  return (
    <div className="stack-lg">
      ...
      <div className="kpi-grid kpi-grid-4">
        <div className="card kpi-card"><span>Empresa usuária</span><strong>{license?.company_name || selectedProfile?.user_company_name || 'Não configurada'}</strong><p className="muted">Cadastro licenciado da aplicação.</p></div>
      ...
      <div className="grid-two dashboard-grid">
        <div className="card">
          ...
          <ol className="clean-list">
            <li>Configure a empresa usuária e o webservice de licenciamento.</li>
