...
export default function DashboardPage() {
  ...
  return (
    <div className="stack-lg">
      <PageHeader title="Painel operacional" subtitle="Entrada de documentos, perfis por empresa e acompanhamento do licenciamento por estação." />
      ...
      <div className="kpi-grid kpi-grid-4">
        ...
        <div className="card kpi-card"><span>Status da licença</span><strong>{license ? (license.allowed ? 'Liberada' : 'Bloqueada') : 'Pendente'}</strong><p className="muted">{license?.message || 'Configure CNPJ/CPF em Configurações.'}</p></div>
      </div>
      ...
      <div className="grid-two dashboard-grid">
        <div className="card">
          ...
          <ol className="clean-list">
            <li>Configure Razão Social e CNPJ/CPF.</li>
            <li>Cadastre um ou mais perfis para escrituração.</li>
        ...
        <div className="card">
          ...
          <p className="muted">A estação utiliza chave de máquina e validação centralizada. URL do serviço, instância e auto cadastro ficam fixos no runtime.</p>
