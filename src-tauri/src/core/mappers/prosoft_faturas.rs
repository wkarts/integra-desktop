...
#[cfg(test)]
mod tests {
    use super::map_document_to_fatura_line;
    use crate::core::domain::document::{ConversionProfile, NfseDocument};
    use crate::core::domain::party::Party;
    use crate::core::domain::taxes::Taxes;

    #[test]
    fn define_tipo_registro_faturas() {
        ...
        let line = map_document_to_fatura_line(&document, &profile).expect("ok");
